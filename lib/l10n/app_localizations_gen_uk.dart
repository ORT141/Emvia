...
class AppLocalizationsGenUk extends AppLocalizationsGen {
  AppLocalizationsGenUk([String locale = 'uk']) : super(locale);
  ...
  @override
  String get headphones => 'Навушники';

  @override
  String get headphonesOff => 'Заспокоїтись';
  ...
  @override
  String get exitConfirm => 'Ви впевнені, що хочете вийти?';
  ...
  @override
  String get artistAndDesigner => 'Художник і дизайнер';

  @override
  String get breathingGuide => 'Ніжний гайд для заспокоєння';
  ...
  String get stage_item_book_description =>
      'Перелистування книжки може бути дуже заспокійливою активністю. Повторювані рухи дають відчуття контролю. Тактильні відчуття (шурхіт сторінок, текстура) регулюють нервову систему. Правильний ресурс.';

  @override
  String get stage_item_bag_of_rocks_title => 'Мішечок з камінчиками';
  ...
  String get stage_item_hibuki_description =>
      'Терапевтична м’яка іграшка-песик, що використовується для емоційну підтримку дітей, особливо тих, хто пережив стрес або травматичні події. Зниження тривожності відбувається через обійми (глибокий тиск заспокоює нервову систему). Правильний ресурс.';

  @override
  String get stage_item_rocking_chair_title => 'Крісло-гойдалка';

  @override
  String get stage_item_rocking_chair_description =>
      'Допомагає заспокоїтися, зняти напругу та регулювати моторику через рух. Гойдання допомагає нервовій системі «переключитися» і знизити тривожність. Правильний ресурс.';
  ...
  @override
  String get next_item => 'Наступний предмет';
  ...
  String get liam_comments_intro =>
      'Мої фотографії - це не просто знімки.\nЦе історії про те, що я бачу, відчуваю і переживаю у цьому місті. Кожен кадр - це голос, який розповідає про мої виклики та перемоги.';
