    ...
    return MaterialApp(
      ...
      home: GameWidget<EmviaGame>.controlled(
        ...
        overlayBuilderMap: {
          ...
          'LiamCafeNear': (context, game) => CafeSceneOverlay(
            game: game,
            imagePath: 'assets/images/misc/liam-cafe-entrance/near.png',
            text: AppLocalizationsGen.of(context)!.liam_boundary_npc,
            onDismiss: () {
              if (game.overlays.isActive('LiamCafeGrab')) return;
              game.overlays.remove('LiamCafeNear');
              game.overlays.add('LiamCafeGrab');
            },
          ),
          'LiamCafeGrab': (context, game) => CafeSceneOverlay(
            game: game,
            imagePath:
